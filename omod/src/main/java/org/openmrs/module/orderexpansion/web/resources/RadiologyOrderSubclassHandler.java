...
public class RadiologyOrderSubclassHandler extends BaseDelegatingSubclassHandler<Order, RadiologyOrder> implements DelegatingSubclassHandler<Order, RadiologyOrder> {
	...
	public PageableResult getAllByType(RequestContext requestContext) throws ResourceDoesNotSupportOperationException {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getAllByType");
	...
	public DelegatingResourceDescription getUpdatableProperties() throws ResourceDoesNotSupportOperationException {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getUpdatableProperties");
	...
	public static String getDisplay(RadiologyOrder delegate) {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getDisplay");
		OrderResource2_5 orderResource = (OrderResource2_5) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Order.class);
	...
	public DelegatingResourceDescription getRepresentationDescription(Representation rep) {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getRepresentationDescription");
	...
	public DelegatingResourceDescription getCreatableProperties() {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getCreatableProperties");
		OrderResource2_5 orderResource = (OrderResource2_5) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Order.class);
	...
	public Model getGETModel(Representation rep) {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getGETModel");
		OrderResource2_5 orderResource = (OrderResource2_5) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Order.class);
	...
	public Model getCREATEModel(Representation rep) {
		LOGGER.info("[orderexpansion] Inside RadiologyOrderSubclassHandler.getCREATEModel");
		OrderResource2_5 orderResource = (OrderResource2_5) Context.getService(RestService.class)
		        .getResourceBySupportedClass(Order.class);
